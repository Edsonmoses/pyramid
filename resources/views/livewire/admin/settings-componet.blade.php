...
<div class="py-12">
   ...
   <button wire:click="closeModalPopover()"
        ...
        @include('livewire.admin.add-settings-componet')
  @elseif($editModalOpen)
  ...
  <button wire:click="closeModalPopedit()"
        ...
        @include('livewire.admin.edit-settings-componet')
   @else
   <button wire:click="create()"
    ...
    <table class="table table-bordered mt-5">
        ...
        <tbody wire:sortable="updateProjectOrder">
            ...
            <tr wire:sortable.item="{{ $value->id }}" wire:key="project-{{ $value->id }}">
                ...
                <td style="width: 15%">
                <a  href="{{ route('setting.edit',['slug'=>$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>
